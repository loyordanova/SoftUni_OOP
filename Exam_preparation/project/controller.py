...
class Controller:
    ...
    def sustain(self, player_name: str, sustenance_type: str) -> str or None:
        if sustenance_type not in self.TYPES:
            return
    ...
    def duel(self, first_player_name: str, second_player_name: str) -> str:
        ...
        return self.fight_(current_players)
    ...
    def fight_(self, current_players: List[Player]) -> str:
        ...
        # this replaces the whole if statement
